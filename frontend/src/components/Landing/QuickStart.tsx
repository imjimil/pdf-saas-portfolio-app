  ...
  return (
    <div className="w-full rounded-[1.75rem] border hairline bg-white p-2 shadow-lifted dark:bg-white/[0.03]">
      {!file ? (
        ...
        >
          <span className="mx-auto grid h-12 w-12 place-items-center rounded-2xl bg-brand-500/10 text-brand-600 dark:text-brand-400">
                  ...
                  <li key={tool.id}>
                    <button
                      ...
                      className="group flex w-full items-center gap-3 rounded-xl bg-white px-3.5 py-3 text-left
                                 transition-colors hover:bg-brand-500/[0.07] dark:bg-white/[0.05]
